...
{
    MatrixUndirectedWeightedGraph graph;
    MatrixUndirectedWeightedGraph answer;
    /**
    ...
    public void setUp()
    {
        graph = new MatrixUndirectedWeightedGraph();
        answer = new MatrixUndirectedWeightedGraph();
    }
